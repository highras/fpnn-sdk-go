...
如果没有为 [TCPClient] 实例单独配置日志路由，则所有 [TCPClient] 均采用该配置。
...
配置请求超时。
未配置时，默认为 5 秒。
如果没有为 [TCPClient] 实例单独配置请求超时，则所有 [TCPClient] 均采用该配置。
...
配置连接超时。
未配置时，默认为 5 秒。
如果没有为 [TCPClient] 实例单独配置连接超时，则所有 [TCPClient] 均采用该配置。
